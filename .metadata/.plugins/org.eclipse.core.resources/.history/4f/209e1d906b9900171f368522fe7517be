...
//		System.out.println(Calculate.round2(-233.1588));
...
//		System.out.println(Calculate.sqrt(121));
		System.out.println(Calculate.rangeOfNumbers(2, 8));
		System.out.println(Calculate.rangeOfNumbers(18, 11));
		System.out.println(Calculate.rangeOfNumbers(42, 42));
