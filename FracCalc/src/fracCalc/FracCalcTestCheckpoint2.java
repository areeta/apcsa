...
public class FracCalcTestCheckpoint2
{
    ...
    @Test public void testCheckpoint2_3() {  FracCalcTestALL.assertForEarlyCheckpoints(null, "whole:1 numerator:6 denominator:21", "-33_2/7", FracCalc.produceAnswer("-32 - 27/21"));}
}
